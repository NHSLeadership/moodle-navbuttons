...
define("BLOCK_NAVBUTTONS_COMPLETEBUTTON_BEFORE", 'before');
define("BLOCK_NAVBUTTONS_COMPLETEBUTTON_MIDDLE", 'middle');
define("BLOCK_NAVBUTTONS_COMPLETEBUTTON_AFTER", 'after');